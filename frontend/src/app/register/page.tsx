...
import { Sparkles, Mail, Lock, User, Loader2, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('An unexpected error occurred. Please check your connection details.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('div', { className: 'w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto text-primary' }, React.createElement(Sparkles, { className: 'w-6 h-6' })),
        React.createElement('h2', { className: 'text-2xl font-outfit font-extrabold text-slate-800' }, 'Create Account'),
        React.createElement('p', { className: 'text-xs text-slate-500 font-medium' }, 'Access modern RAG search engines and verified guides')
      ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('label', { className: 'text-xs font-semibold text-slate-600' }, 'Full Name'),
          React.createElement(
            'div',
            { className: 'relative' },
            React.createElement(User, { className: 'absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4' }),
        ...
        React.createElement(
          ...
          React.createElement('span', null, submitting ? 'Creating Account...' : 'Sign Up Free')
        )
      ),
      ...
      React.createElement(
        ...
        React.createElement(Link, { href: '/login', className: 'font-semibold text-primary hover:underline' }, 'Sign In')
      )
    )
  );
}
